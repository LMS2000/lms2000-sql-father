...
export async function listReportByPage(params: ReportType.ReportQueryRequest) {
  return request<ResultData<PageInfo<ReportType.Report>>>(
    '/report/list/page',
    {
      method: 'GET',
      params,
...
export async function addReport(params: ReportType.ReportAddRequest) {
  return request<ResultData<number>>('/report/add', {
    method: 'POST',
    headers: {
...
export async function getReportById(id: number) {
  return request<ResultData<ReportType.Report>>(`/report/get`, {
    method: 'GET',
    params: { id },
  });
}
...
export async function updateReport(params: ReportType.ReportUpdateRequest) {
  return request<ResultData<boolean>>(`/report/update`, {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function deleteReport(params: DeleteRequest) {
  return request<ResultData<boolean>>(`/report/delete`, {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
