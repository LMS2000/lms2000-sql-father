...
export async function listTableInfo(params: TableInfoType.TableInfoQueryRequest) {
  return request<ResultData<TableInfoType.TableInfo[]>>('/table_info/list', {
    method: 'GET',
    params,
  });
}
...
export async function listMyTableInfo(params: TableInfoType.TableInfoQueryRequest) {
  return request<ResultData<TableInfoType.TableInfo[]>>('/table_info/my/list', {
    method: 'GET',
    params,
  });
}
...
export async function listMyAddTableInfoByPage(params: TableInfoType.TableInfoQueryRequest) {
  return request<ResultData<PageInfo<TableInfoType.TableInfo>>>('/table_info/my/add/list/page', {
    method: 'GET',
    params,
  });
}
...
export async function listMyTableInfoByPage(params: TableInfoType.TableInfoQueryRequest) {
  return request<ResultData<PageInfo<TableInfoType.TableInfo>>>('/table_info/my/list/page', {
    method: 'GET',
    params,
  });
}
...
export async function listTableInfoByPage(params: TableInfoType.TableInfoQueryRequest) {
  return request<ResultData<PageInfo<TableInfoType.TableInfo>>>('/table_info/list/page', {
    method: 'GET',
    params,
  });
}
...
export async function addTableInfo(params: TableInfoType.TableInfoAddRequest) {
  return request<ResultData<number>>('/table_info/add', {
    method: 'POST',
    headers: {
...
export async function getTableInfoById(id: number) {
  return request<ResultData<TableInfoType.TableInfo>>(`/table_info/get`, {
    method: 'GET',
    params: { id },
  });
}
...
export async function updateTableInfo(params: TableInfoType.TableInfoUpdateRequest) {
  return request<ResultData<boolean>>(`/table_info/update`, {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function deleteTableInfo(params: DeleteRequest) {
  return request<ResultData<boolean>>(`/table_info/delete`, {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function generateCreateTableSql(id: number) {
  return request<ResultData<string>>(`/table_info/generate/sql`, {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
