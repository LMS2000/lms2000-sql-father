...
export async function listDict(params: DictType.DictQueryRequest) {
  return request<ResultData<DictType.Dict[]>>('/dict/list', {
    method: 'GET',
    params,
  });
}
...
export async function listMyDict(params: DictType.DictQueryRequest) {
  return request<ResultData<DictType.Dict[]>>('/dict/my/list', {
    method: 'GET',
    params,
  });
}
...
export async function listMyAddDictByPage(params: DictType.DictQueryRequest) {
  return request<ResultData<PageInfo<DictType.Dict>>>('/dict/my/add/list/page', {
    method: 'GET',
    params,
  });
}
...
export async function listMyDictByPage(params: DictType.DictQueryRequest) {
  return request<ResultData<PageInfo<DictType.Dict>>>('/dict/my/list/page', {
    method: 'GET',
    params,
  });
}
...
export async function listDictByPage(params: DictType.DictQueryRequest) {
  return request<ResultData<PageInfo<DictType.Dict>>>('/dict/list/page', {
    method: 'GET',
    params,
  });
}
...
export async function addDict(params: DictType.DictAddRequest) {
  return request<ResultData<number>>('/dict/add', {
    method: 'POST',
    headers: {
...
export async function getDictById(id: number) {
  return request<ResultData<DictType.Dict>>(`/dict/get`, {
    method: 'GET',
    params: { id },
  });
}
...
export async function updateDict(params: DictType.DictUpdateRequest) {
  return request<ResultData<boolean>>(`/dict/update`, {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function deleteDict(params: DeleteRequest) {
  return request<ResultData<boolean>>(`/dict/delete`, {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function generateCreateDictTableSql(id: number) {
  return request<ResultData<GenerateVO>>(`/dict/generate/sql`, {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
