...
export async function listFieldInfo(params: FieldInfoType.FieldInfoQueryRequest) {
  return request<ResultData<FieldInfoType.FieldInfo[]>>('/field_info/list', {
    method: 'GET',
    params,
  });
}
...
export async function listMyFieldInfo(params: FieldInfoType.FieldInfoQueryRequest) {
  return request<ResultData<FieldInfoType.FieldInfo[]>>('/field_info/my/list', {
    method: 'GET',
    params,
  });
}
...
export async function listMyAddFieldInfoByPage(params: FieldInfoType.FieldInfoQueryRequest) {
  return request<ResultData<PageInfo<FieldInfoType.FieldInfo>>>('/field_info/my/add/list/page', {
    method: 'GET',
    params,
  });
}
...
export async function listMyFieldInfoByPage(params: FieldInfoType.FieldInfoQueryRequest) {
  return request<ResultData<PageInfo<FieldInfoType.FieldInfo>>>('/field_info/my/list/page', {
    method: 'GET',
    params,
  });
}
...
export async function listFieldInfoByPage(params: FieldInfoType.FieldInfoQueryRequest) {
  return request<ResultData<PageInfo<FieldInfoType.FieldInfo>>>('/field_info/list/page', {
    method: 'GET',
    params,
  });
}
...
export async function addFieldInfo(params: FieldInfoType.FieldInfoAddRequest) {
  return request<ResultData<number>>('/field_info/add', {
    method: 'POST',
    headers: {
...
export async function getFieldInfoById(id: number) {
  return request<ResultData<FieldInfoType.FieldInfo>>(`/field_info/get`, {
    method: 'GET',
    params: { id },
  });
}
...
export async function updateFieldInfo(params: FieldInfoType.FieldInfoUpdateRequest) {
  return request<ResultData<boolean>>(`/field_info/update`, {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function deleteFieldInfo(params: DeleteRequest) {
  return request<ResultData<boolean>>(`/field_info/delete`, {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function generateCreateFieldSql(id: number) {
  return request<ResultData<string>>(`/field_info/generate/sql`, {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
